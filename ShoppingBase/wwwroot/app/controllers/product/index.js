var productController = function () {
    ...
    function saveProduct(e) {
        if ($('#frmMaintainance').valid()) {
            ...
            var giongnho = $('#txtGiongnho').val();
            var nongdo = $('#txtNongdo').val();
            var mauruou = $('#txtMau').val();
            var dungtich = $('#txtDungtich').val();
            var nhietdo = $('#txtNhietdo').val();
            var thoigian = $('#txtThoigian').val();

         //   console.log({ country, region, giongnho, nongdo, mauruou, dungtich, nhietdo, thoigian})
    ...
    function loadDetails(that) {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#txtContry').val(data.Country);
                $('#txtRegion').val(data.Region);
                $('#txtGiongnho').val(data.GiongNho);
                $('#txtNongdo').val(data.NongDo);
                $('#txtMau').val(data.MauRuou);
                $('#txtDungtich').val(data.DungTich);
                $('#txtNhietdo').val(data.Temperature);
                $('#txtThoigian').val(data.ThoiGian);
