...
namespace ShoppingBase.Data.Entities
{
        ...
        IHasSeoMetaData, ISwitchable, ISortable, IDateTracking
    {
        ...
        public ProductCategory(string name,string description, int? parentId,int? homeOrder,
            string image,bool? homeFlag,bool? showHome ,int sortOrder,Status status,string seoPageTitle,string seoAlias,
        ...
        public bool? ShowHome { get; set; } // hien thi trang chu
